    ...
    })(
        {
            1: [
                function (require, module, exports) {
                    ...
                    var _defaultParams2 =
                        _interopRequireWildcard(_defaultParams);

                    var _setParameters = require('./modules/set-params');

                    var _setParameters2 =
                        _interopRequireWildcard(_setParameters);
                            ...
                            function () {
                                ...
                                switch (typeof customizations) {
                                    ...
                                    case 'object':
                                        ...
                                        for (var customName in _defaultParams2[
                                            'default'
                                        ]) {
                                            params[customName] =
                                                argumentOrDefault(customName);
                                        }
                                ...
                                var onKeyEvent = function onKeyEvent(e) {
                                    return _handleKeyDown2['default'](
                                        e,
                                        params,
                                        modal
                                    );
                     ...
                     */
                    sweetAlert.setDefaults = swal.setDefaults = function (
                        userParams
                    ) {
                        if (!userParams) {
                    ...
                    sweetAlert.close = swal.close = function () {
                        ...
                        var $errorIcon =
                            modal.querySelector('.sa-icon.sa-error');
                        _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.removeClass(
                            $errorIcon,
                            'animateErrorIcon'
                        );
                        ...
                        setTimeout(function () {
                            var customClass =
                                modal.getAttribute('data-custom-class');
                            _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.removeClass(
                                modal,
                                customClass
                            );
                    ...
                    sweetAlert.showInputError = swal.showInputError = function (
                        ...
                        var $errorContainer = modal.querySelector(
                            '.sa-error-container'
                        );
                        _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.addClass(
                            $errorContainer,
                     ...
                     */
                    sweetAlert.resetInputError = swal.resetInputError =
                        function (event) {
                            ...
                            var $errorIcon =
                                $modal.querySelector('.sa-input-error');
                            _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation.removeClass(
                                $errorIcon,
                                'show'
                            );
                     ...
                     */
                    sweetAlert.disableButtons = swal.disableButtons = function (
                        event
                    ) {
                        var modal =
                            _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
                        ...
                        var $cancelButton =
                            modal.querySelector('button.cancel');
                     ...
                     */
                    sweetAlert.enableButtons = swal.enableButtons = function (
                        event
                    ) {
                        var modal =
                            _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
            ...
            3: [
                function (require, module, exports) {
                    ...
                    var handleButton = function handleButton(
                        ...
                        var targetedConfirm =
                            target.className.indexOf('confirm') !== -1;
                        var targetedOverlay =
                        ...
                        var doneFunctionExists =
                            params.doneFunction &&
                            modal.getAttribute('data-has-done-function') ===
                                'true';
                        ...
                        if (targetedConfirm && params.confirmButtonColor) {
                            ...
                            hoverColor = _colorLuminance.colorLuminance(
                                normalColor,
                                -0.04
                            );
                            activeColor = _colorLuminance.colorLuminance(
                                normalColor,
                                -0.14
                            );
                        }
                        ...
                        switch (e.type) {
                            ...
                            case 'click':
                                ...
                                var clickedOnModalChild =
                                    _hasClass$isDescendant.isDescendant(
                                        modal,
                                        target
                                    );
                    ...
                    var handleConfirm = function handleConfirm(modal, params) {
                        ...
                        if (
                            _hasClass$isDescendant.hasClass(modal, 'show-input')
                        ) {
                ...
                function (require, module, exports) {
                    ...
                    var handleKeyDown = function handleKeyDown(
                        ...
                        var $cancelButton =
                            modal.querySelector('button.cancel');
                        var $modalButtons =
                            modal.querySelectorAll('button[tabindex]');
                        ...
                        if (keyCode === 9) {
                            ...
                            if (btnIndex === -1) {
                                ...
                                if (btnIndex === $modalButtons.length - 1) {
                                    ...
                                    $targetElement =
                                        $modalButtons[btnIndex + 1];
                                }
                            }

                            _stopEventPropagation$fireClick.stopEventPropagation(
                                e
                            );
                            $targetElement.focus();
                            ...
                            if (keyCode === 13) {
                                ...
                                _stopEventPropagation$fireClick.fireClick(
                                    $targetElement,
                                    e
                                );
                            } else {
            ...
            6: [
                function (require, module, exports) {
                     ...
                     */
                    var setFocusStyle = function setFocusStyle(
                        $button,
                        bgColor
                    ) {
                    ...
                    var openModal = function openModal(callback) {
                        ...
                        _removeClass$getTopMargin$fadeIn$show$addClass.show(
                            $modal
                        );
                    ...
                    var resetInput = function resetInput() {
                        ...
                        $input.setAttribute(
                            'type',
                            _defaultParams2['default'].inputType
                        );
                        $input.setAttribute(
                            'placeholder',
                    ...
                    var setParameters = function setParameters(params) {
                        ...
                        if (params.type && !_isIE8.isIE8()) {
                            var _ret = (function () {
                                ...
                                if (!validType) {
                                    logStr(
                                        'Unknown alert type: ' + params.type
                                    );
                                    return {
                                        v: false,
                                    };
                                ...
                                if (
                                    typesWithIcons.indexOf(params.type) !== -1
                                ) {
                                ...
                                var $input =
                                    _getModal$getInput$setFocusStyle.getInput();
                        ...
                        if (params.imageUrl) {
                            var $customIcon =
                                modal.querySelector('.sa-icon.sa-custom');
                            ...
                            if (params.imageSize) {
                                var dimensions = params.imageSize
                                    .toString()
                                    .split('x');
